...
- [第一集《背面》](revisions/opening-pair-v2/episode-01.txt)
- [第二集《纸留下》](revisions/opening-pair-v2/episode-02.txt)
...
根目录 `episode-01.txt`、`episode-02.txt` 对应已生成的46.750秒与41.917秒原版样片，保留不改。

`episode-02/revision-03.txt` 是此前只改第二集的中间稿，保留用于对照。后续制作应采用上述两集合改版本，避免混用前情、对白和道具状态。

已认可的画面方向与原生产逻辑保存在节点 `h3-novel-performance-v1-20260919`，详见项目 `docs/production-checkpoints/README.md`。新稿沿用其人物参考、书房、声源分工和字幕风格，不宣称整体成片已达到商业发行标准。
