...
export const scriptApi = {
  ...
  generateOutlinePreviewStream: (data: ScriptGenerateParams, handlers: StreamHandlers) =>
    streamPreview('/scripts/generate/outline/stream', data, handlers),
  ...
  ) => streamPreview('/scripts/generate/stream', data, handlers),
