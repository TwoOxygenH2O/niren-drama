...
# Since I may have inserted it multiple times, let's remove it entirely, then append once if needed, or if it is already there at the VERY BOTTOM, just leave it?
# The error was "已在类 ... 定义了方法". Meaning it is already defined!
# So I should remove all occurrences of 'val' that I injected.

c = text.count(val)
print("Found injects:", c)
